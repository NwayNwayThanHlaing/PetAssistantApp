...
//       // Ensure that notifications is an array
//       const notifications = Array.isArray(response) ? response : [];

//       // If notifications are found, update state; otherwise, show an alert
...
//     // Ensure that item.date is in the format mm-dd-yyyy (e.g., "12-07-2024")
...
//           <FlatList
//             data={data}
//             keyExtractor={(item, index) => item.notification_id.toString()} // Use notification_id for unique key
...
export default function IndieNotificationInbox({ navigation }) {
  ...
  // Render each notification item using map() within ScrollView
